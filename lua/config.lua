...
-- vim.opt.errorformat:append('toto%f')

-- vim.opt.errorformat:append "File\ %f\\,\ line"
-- vim.opt.errorformat   = vim.opt.errorformat + '%.%#File \"%f\"\\, line %l\\,%#%m'
-- vim.opt.errorformat   = vim.opt.errorformat + 'foo %f'
