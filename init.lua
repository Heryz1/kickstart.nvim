...
-- vim.o.hlsearch = false # TODO est-ce utile maintenat ?
...
vim.defer_fn(function()
    require('nvim-treesitter.configs').setup {
        ...
        ensure_installed = { 'c', 'cpp', 'go', 'rst', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript',
            'vimdoc', 'vim', 'bash' },
...
-- Add a custom lua file to define user settings
require 'config'
require 'autocommand'
require 'keybindings'
require 'netrw'
